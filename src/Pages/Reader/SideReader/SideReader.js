...
const SideReader = ({ data, handleChapter, currentChapter, mangaTitle, currImg, maxImg, handleImage, readMode, setReadMode }) => {
        ...
        <div className="side-chapter-wrapp" style={{backgroundColor: 'white', minWidth: '250px'}}>
            ...
            <div className="side-chapter-controls">
                ...
                <div style={{ marginTop: '10px' }}>
                    <p style={{ fontWeight: 'bold', fontSize: '11pt', marginBottom: '8px', color: '#2f383e' }}>Reading Mode</p>
                    <div style={{ display: 'flex', gap: '8px' }}>
                        <button
                            ...
                            style={{
                                ...
                                padding: '8px 12px',
                                cursor: 'pointer',
                                backgroundColor: readMode === 'single' ? '#ff6740' : '#f0f1f2',
                                color: readMode === 'single' ? 'white' : '#2f383e',
                                border: 'none',
                                borderRadius: '4px',
                                fontWeight: 'bold',
                                fontSize: '10pt',
                        ...
                        <button
                            ...
                            style={{
                                ...
                                padding: '8px 12px',
                                cursor: 'pointer',
                                backgroundColor: readMode === 'scroll' ? '#ff6740' : '#f0f1f2',
                                color: readMode === 'scroll' ? 'white' : '#2f383e',
                                border: 'none',
                                borderRadius: '4px',
                                fontWeight: 'bold',
                                fontSize: '10pt',
