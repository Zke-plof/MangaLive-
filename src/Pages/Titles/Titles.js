...
const Titles = memo(({ hasFilter = true, customTitle = '', handleManga }) => {
	...
	return (
		...
		>
			<Helmet>
				<meta charSet="utf-8" />
				<title>Search Manga | MangaLive</title>
				<meta name="description" content="Search, filter, and discover your next favorite manga, manhwa, or manhua on MangaLive with our advanced multi-tag search engine." />
			</Helmet>
			<PageArrowLink
