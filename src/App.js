...
import { Main, Favorites, Manga, Chapter, Signup, Signin, Suggestion, Category } from './Pages';
...
import AnimePortal from './Pages/Anime/AnimePortal';
    ...
    <div className="App">
      ...
      <div className="content__wrap">
        ...
        <Routes>
          ...
          <Route path='/info/:page' element={<StaticInfo />} />
          <Route path='/anime' element={<AnimePortal />} />
