...
const titleSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            .addCase(fetchFilterTags.pending, (state, action) => setLoading(state, action, 'filterTags'))
            .addCase(fetchFilterTags.fulfilled, (state, action) => setResolved(state, action, 'filterTags'))
            .addCase(fetchFilterTags.rejected, (state, action) => setError(state, action, 'filterTags'))

            .addCase(fetchFilteredData.pending, (state, action) => setLoading(state, action, 'filteredData'))
            .addCase(fetchFilteredData.fulfilled, (state, action) => setResolved(state, action, 'filteredData'))
            .addCase(fetchFilteredData.rejected, (state, action) => setError(state, action, 'filteredData'));
    }
})
